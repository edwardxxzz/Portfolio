        ...
        <div className="projects-list">
          {projects.map((p, idx) => (
            <div 
              ...
              onClick={() => window.open(p.site, "_blank", "noopener,noreferrer")} // <-- Abre o site ao clicar no card
            ...
            >
              ...
              <div className="project-content-side">
                ...
                <a
                  ...
                  onClick={(e) => e.stopPropagation()} // <-- Impede que o clique no botão do GitHub acione o clique do card
                >
